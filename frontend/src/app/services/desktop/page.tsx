...
import { Monitor, CheckCircle, Star } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-slate-800 font-mono mb-6">
              <span className="text-blue-600">Masaüstü</span> <GlitchText text="Yazılım" />
            </h1>
            <div className="text-xl text-slate-600 font-mono max-w-3xl mx-auto">
              <Typewriter 
                text="Windows, macOS ve Linux için özel masaüstü uygulamaları geliştiriyoruz."
                speed={40}
                loop={false}
              />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-lg text-slate-600 font-mono">
              Masaüstü yazılım geliştirme hizmetlerimiz hakkında detaylı bilgi için ana hizmetler sayfasını ziyaret edin.
            </p>
            <div className="mt-8">
              <a 
                href="/services" 
